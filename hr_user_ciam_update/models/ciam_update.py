...
class CIAMUpdate(models.TransientModel):
    ...
    def action_update_ciam(self):
        ...
        if ciam_id:
            data = {
                'personNr': self.employee_id.ssnid if self.employee_id.ssnid else "197001011234",  # noqa:E501
                ...
                # 'password': self.employee_id.user_id.password if self.employee_id.user_id.password else "Acctest09",  # noqa:E501
